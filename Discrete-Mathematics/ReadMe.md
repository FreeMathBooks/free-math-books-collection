...
*Direct links to curated Discrete Mathematics books:*
...
* 📖 **[Algebraic Combinatorics on Words](http://localhost:17966/B.aspx?FileName=Algebraic-Combinatorics-Words--M-Lothaire)** — *by M. Lothaire*
* 📖 **[An Introduction to Number Theory](http://localhost:17966/B.aspx?FileName=An-Intro-Number-Theory--JJP-Veerman)** — *by J. J. P. Veerman*
* 📖 **[An Introduction to the Theory of Numbers](http://localhost:17966/B.aspx?FileName=An-Intro-Theory-Numbers--Leo-Moser)** — *by Leo Moser*
* 📖 **[Explorations in Algebraic Graph Theory](http://localhost:17966/B.aspx?FileName=Explorations-Algebraic-Graph-Theory--Chris-Godsil)** — *by Chris Godsil, Rob Beezer*
* 📖 **[Groups as Graphs](http://localhost:17966/B.aspx?FileName=Groups-Graphs--Vasantha-Kandasamy)** — *by Kandasamy & Smarandache*
